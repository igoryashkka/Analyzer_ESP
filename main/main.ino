      ...
      if (client.available()) {             
        ...
        if (c == '\n') {                  
          ...
          if(!isMesurment){
            ...
            client.println("<div> <canvas id=\"myChart\"></canvas> </div> ");
